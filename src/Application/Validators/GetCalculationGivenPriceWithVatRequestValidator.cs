...
public class GetCalculationGivenPriceWithVatRequestValidator : AbstractValidator<GetCalculationGivenPriceWithVatRequest>
{
    public GetCalculationGivenPriceWithVatRequestValidator()
    {
